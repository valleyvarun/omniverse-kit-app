...
class HotkeyManager:
    ...
    def register(self) -> None:
        ...
        # extension.py imports hotkeys before tools/__init__.py runs, and
        # tools/__init__.py also imports transform_tools, causing partial-
        # initialization errors. By register() time tools is fully loaded.
